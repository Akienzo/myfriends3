...
$sql = 'SELECT * FROM `friends` RIGHT OUTER JOIN `areas` ON `friend_id`='.$_GET['friend_id'];
var_dump($sql);
      ...
      <div class="col-md-4 content-margin-top">
        ...
        <form method="post" action="edit.php" class="form-horizontal" role="form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="friend_name" class="form-control" placeholder="山田　太郎" value="<?php echo $areas[0]['friend_name']; ?>">
              </div>
            </div>
            <!-- 出身 -->
            <div class="form-group">
              ...
              <?php foreach ($areas as $area) {
                      if ($area[0]['area_id']==$area[0]['area_id']){ ?>
                  <option value="<?php echo $area[0]['area_id']; ?>" selected><?php echo $area[0]['area_name'] ?></option>
                <?php } else { ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="age" class="form-control" placeholder="例：27" value="<?php echo $areas[0]['age']; ?>">
              </div>
            </div>
